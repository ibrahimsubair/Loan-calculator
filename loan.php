...
function myFunction() {
  ...
  /* document.querySelectorAll('#table-container table').reset(); */
  

  
  /* var tabless = document.querySelectorAll('#table-container table'); */
...
<select id="selector" class="mdb-select md-form input-cls ml-3" >
...
<div class="subdivcls">
<input type="submit" name="calc"  class="btn btn-blue-grey" value="Calculate" onclick="calculate()">
</div>
