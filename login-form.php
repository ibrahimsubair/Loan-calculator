...
else if($username=='ella' && $password=='ella123'){
    header('location:registration.php');
}

else if($username=='mr ayo' && $password=='ayo123'){
    header('location:registration.php');
}
    ...
    <div class="first-div">
        ...
        <form action="Niit.php" method="post" name="login-form">
                ...
                <label class="small">
                    ...
                    <input type="text" name="username" class="input-cls form-control " required>
                </label>


                <label class="label-cls small">
                    <span>Your Email address</span>
                    <input type="email" name="email" class="input-cls form-control" required>
                </label>

                <label class="label-cls small">
                    <span>Password</span>
                    <input type="password" name="password" class="input-cls form-control" required>
                </label>
